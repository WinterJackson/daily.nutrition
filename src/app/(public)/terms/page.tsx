    ...
    <div className="min-h-screen bg-off-white dark:bg-charcoal relative pb-16 pt-32">
      ...
      <div className="relative container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-charcoal dark:text-off-white mb-4">Terms of Service</h1>
        ...
        <div className="prose prose-lg max-w-none text-charcoal/80 dark:text-off-white/80 space-y-8 bg-white/80 dark:bg-white/5 p-8 md:p-12 rounded-2xl shadow-sm border border-neutral-100 dark:border-white/10">
          ...
          {settings?.termsContent ? (
            ...
            <>
              ...
              <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">2. Description of Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">3. Medical Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">4. Intellectual Property Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">5. User Conduct</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">6. Booking and Scheduling</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">7. Payment Terms and Taxation</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">8. Cancellation and Refund Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">9. Third-Party Links and Integrations</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">10. Data Protection and Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">11. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">12. Indemnification</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">13. Disclaimer of Warranties</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">14. Dispute Resolution (Arbitration)</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">15. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">16. Amendments to Terms</h2>
            <p>
