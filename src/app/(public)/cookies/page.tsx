    ...
    <div className="min-h-screen bg-off-white dark:bg-charcoal relative pb-16 pt-32">
      ...
      <div className="relative container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-charcoal/80 dark:text-off-white/80 space-y-8 bg-white/80 dark:bg-white/5 p-8 md:p-12 rounded-2xl shadow-sm border border-neutral-100 dark:border-white/10">
          ...
          <section>
            ...
            <div className="space-y-6 mt-6">
              <div className="border-l-4 border-orange pl-4">
                <h3 className="text-xl md:text-2xl font-semibold text-charcoal dark:text-off-white mb-2">Essential / Strictly Necessary Cookies</h3>
                <p>
              ...
              <div className="border-l-4 border-olive pl-4">
                <h3 className="text-xl md:text-2xl font-semibold text-charcoal dark:text-off-white mb-2">Analytical / Performance Cookies</h3>
                <p>
              ...
              <div className="border-l-4 border-gold pl-4">
                <h3 className="text-xl md:text-2xl font-semibold text-charcoal dark:text-off-white mb-2">Functionality Cookies</h3>
                <p>
              ...
              <div className="border-l-4 border-charcoal/20 pl-4">
                <h3 className="text-xl md:text-2xl font-semibold text-charcoal dark:text-off-white mb-2">Targeting Cookies</h3>
                <p>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif text-olive dark:text-brand-green mb-4">5. Revisions to this Policy</h2>
            <p>
