            ...
            <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    >
                        ...
                        science-backed, personalized strategies.
                    </motion.p>
                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 min-h-75">
                                ...
                                <div className="hidden md:block md:col-span-4 lg:col-span-3 relative bg-neutral-100 dark:bg-white/5">
                                    {discoveryService.image ? (
                                        <>
                                            <div className="absolute inset-y-0 left-0 w-24 bg-linear-to-r from-white/60 dark:from-white/0 to-transparent z-10" />
                                            <Image
                                ...
                                <CardHeader className="relative p-0 overflow-hidden">
                                    {service.image && (
                                        <div className="w-full h-56 relative">
                                            ...
                                            />
                                            <div className="absolute inset-0 bg-linear-to-t from-white dark:from-charcoal to-transparent opacity-90"></div>
                                        </div>
                                    )}
                                    <div
